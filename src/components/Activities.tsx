...
const sampleActivities: Event[] = [
  {
    ...
    images: [
      ...
      'hhttps://drive.google.com/file/d/1eDV83lVdMaU3pfZ34eywjOfStem_MaAJ/view?usp=drive_link',
    ],
    participants: 85,
  ...
  },
  {
    ...
    description: 'Guest lecture by Dr. Sarah Johnson, Chief AI Scientist at MedTech Innovations, discussing how artificial intelligence is revolutionizing healthcare diagnostics, treatment planning, and patient care. The session included live demos of AI-powered medical imaging analysis, predictive analytics for disease detection, and insights into the future of personalized medicine.',
    images: [
      'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&h=600&fit=crop',
    ],
    participants: 200,
    tags: ['Healthcare', 'AI Applications', 'Guest Speaker', 'Medical Tech'],
  },
  {
    id: '4',
    category: 'Project',
    ...
    description: 'Collaborative project where members developed an AI-powered chatbot to help students navigate campus resources, find study groups, and get answers to common questions. The project utilized natural language processing and was deployed campus-wide. Students learned about conversational AI, intent recognition, and building scalable chatbot systems.',
    images: [
    ...
    participants: 45,
    tags: ['NLP', 'Chatbot', 'Campus Project', 'Deployment'],
  },
  {
    id: '5',
    ...
    description: 'Inter-university data science competition featuring challenges in data analysis, predictive modeling, and visualization. Teams competed across multiple rounds, solving real-world datasets from industry partners. Top performers received internship offers and recognition from leading tech companies. The competition tested skills in statistical analysis, machine learning, and data storytelling.',
    images: [
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1543286386-713bdd548da4?w=800&h=600&fit=crop',
    ],
    participants: 150,
    tags: ['Data Science', 'Competition', 'Analytics', 'Visualization'],
  },
  {
    id: '6',
    category: 'Workshop',
    ...
    description: 'Advanced workshop focusing on neural network architectures and deep learning implementation using PyTorch. Covered CNNs, RNNs, and transformer models with practical exercises on image classification and text generation tasks. Participants built and trained their own models while learning about optimization techniques and best practices in deep learning.',
    images: [
      'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&h=600&fit=crop',
    ],
    participants: 75,
    tags: ['Deep Learning', 'PyTorch', 'Neural Networks', 'Advanced'],
  },
];
